...
#### INF-01. Direct Database Compromise via Weak/Default Root Credentials `OWASP A07:2025 - Authentication Failures`
...
#### INF-02. Architecture Misconfiguration `OWASP A02:2025 - Security Misconfiguration`
...
#### INF-03. Sensitive Information Exposure via Development Server `OWASP A02:2025 - Security Misconfiguration`
...
#### BE-01. Internal Authentication Bypass & Data Exposure `OWASP A01:2025 - Broken Access Control`
...
#### BE-02. Cryptographic Failures via Weak Password Hashing `OWASP A04:2025 - Cryptographic Failures`
...
#### BE-03. Missing Anti-Automation and Rate Limiting on Password Reset API `OWASP A06:2025 - Insecure Design`
...
#### BE-04. Insecure CORS Policy & Duplicate Headers `OWASP A02:2025 - Security Misconfiguration`
...
### 3.3. Nhóm FE (Frontend - React & Client-side)
  ...
  #### FE-01. Insecure Storage & UI State Manipulation `OWASP A07:2025 - Authentication Failures`
